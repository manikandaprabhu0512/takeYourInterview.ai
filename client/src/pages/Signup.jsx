      ...
      <div className="flex items-start justify-between">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-300">
            Create an account to start using takeYourInterview.ai.
          </p>
        </div>
        <button
          onClick={onClose}
      ...
      <form className="space-y-4" onSubmit={formik.handleSubmit}>
        ...
        <div className="flex gap-3">
          <button
            type="button"
            onClick={onClose}
            className="flex-1 rounded-xl border border-gray-200 bg-white px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-50 dark:border-gray-700 dark:bg-slate-900 dark:text-gray-200 dark:hover:bg-slate-800"
          >
            Cancel
          </button>
          <button
