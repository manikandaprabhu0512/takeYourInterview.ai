...
function Home() {
  ...
  return (
    <div className="min-h-screen dark:bg-[#030303] bg-[#f3f3f3] flex flex-col">
      <Navbar />
      ...
      `}
              >
                <div className="absolute -top-8 left-1/2 -translate-x-1/2 bg-white dark:bg-slate-800 border-2 border-orange-500 text-orange-600 dark:text-orange-300 w-16 h-16 rounded-2xl flex items-center justify-center shadow-lg">
                  {item.icon}
                </div>
